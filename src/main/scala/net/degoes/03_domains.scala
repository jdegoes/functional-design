...
object pricing_fetcher:
  ...
  /** EXERCISE 1
    *
    * `Schedule` is a data type that models a schedule, which has the ability to indicate whether at any given
    * `java.time.Instant`, it is time to fetch the pricing data set.
    */
